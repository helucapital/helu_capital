...
const Header = ({ seoData }) => {
  ...
  const NavItems = ({ className, css, ...props }) =>
    <Box
      ...
      <NavItem to='/button'>Login</NavItem>
    </Box>
  return (
    <>
          ...
          <Link href="/">
            <a>
              ...
              <svg width="117" height="106" viewBox="0 0 117 106" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path d="M15.7361 67.9719H33.5278V40.5294L15.7361 49.5951V67.9719Z" fill="#5F99B0" />
                <path d="M56.1021 7.75299L38.3103 16.8182V67.9719H56.1021V7.75299Z" fill="#5F99B0" />
                <path d="M60.8853 67.9719H78.677V26.4277L60.8853 17.3625V67.9719Z" fill="#5F99B0" />
                <path d="M83.4736 35.7073V67.9719H101.265V44.7725L83.4736 35.7073Z" fill="#5F99B0" />
                <path d="M28.0051 82.1837H21.2588V72.7538H15.7361V97.2493H21.2588V87.0301H28.0051V97.2493H33.5278V72.7538H28.0051" fill="#5F99B0" />
                <path d="M43.8331 86.9551H54.4869V82.3341H43.8331V77.4123H56.1021V72.7538H38.3103V97.2493H56.4777V92.5903H43.8331" fill="#5F99B0" />
                <path d="M66.408 72.7538H60.8853V97.2493H78.677V92.5903H66.408" fill="#5F99B0" />
                <path d="M95.9008 88.3829C95.9008 89.8609 95.6192 90.988 95.0557 91.764C94.4922 92.5405 93.6216 92.9285 92.4447 92.9285C91.2669 92.9285 90.3734 92.5405 89.8227 91.764C89.2715 90.988 88.9964 89.8609 88.9964 88.3829V72.7538H83.4736V87.8194C83.4736 91.0254 84.2122 93.4733 85.6902 95.1639C87.1678 96.8549 89.4388 97.6999 92.4447 97.6999C95.425 97.6999 97.6352 96.8549 99.0758 95.1639C100.515 93.4733 101.236 91.0254 101.236 87.8189V72.7538H95.9008" fill="#5F99B0" />
              </svg>
